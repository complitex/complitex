 ...
 */
@Stateless
public class FacilityLocalCompensationLoadTaskBean extends FacilityLocalLoadTaskBean{
    @EJB
    private ServiceProviderAdapter serviceProviderAdapter;

    @Override
    protected Cursor<FacilityLocal> getCursor(RequestFile requestFile, String zheuCode, String district) {
        return serviceProviderAdapter.getFacilityLocalCompensation(requestFile.getUserOrganizationId(),
                district, zheuCode, requestFile.getBeginDate());
    }

    @Override
    protected RequestFileSubType getSubType() {
        return RequestFileSubType.FACILITY_LOCAL_COMPENSATION;
    }
}
