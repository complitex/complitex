...
public enum RequestStatus implements IFixedIdType {
    ...
    SUBSIDY_SPLIT_ERROR(259),
    SUBSIDY_RECALCULATED(260),
    SUBSIDY_RECALCULATE_ERROR(261);
    ...
    private static final Set<RequestStatus> UNBOUND_STATUSES = 
            ...
            BINDING_INVALID_FORMAT, PAYMENT_NOT_EXISTS, SERVICING_ORGANIZATION_NOT_FOUND, BENEFIT_OWNER_NOT_ASSOCIATED));
