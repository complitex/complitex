...
import static ru.complitex.osznconnection.organization.strategy.OsznOrganizationStrategy.OSZN_ORGANIZATION_STRATEGY_NAME;
...
//        checkOutputRequestFileStorageExists(parent);
    ...
    public String getRelativeParent(File file, String subPath) {
        return file.getParentFile().getAbsolutePath().substring(new File(subPath).getAbsolutePath().length());
    }
