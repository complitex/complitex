...
ALTER TABLE `oschadbank_response_file` DROP CONSTRAINT `fk_oschadbank_response_file__request_file`;
ALTER TABLE `oschadbank_response_file` ADD CONSTRAINT `fk_oschadbank_response_file__request_file` FOREIGN KEY (`request_file_id`) REFERENCES `request_file` (`id`) ON DELETE CASCADE;

ALTER TABLE `oschadbank_response` DROP CONSTRAINT `fk_oschadbank_response__request_file`;
ALTER TABLE `oschadbank_response` ADD CONSTRAINT `fk_oschadbank_response__request_file` FOREIGN KEY (`request_file_id`) REFERENCES `request_file` (`id`) ON DELETE CASCADE;
