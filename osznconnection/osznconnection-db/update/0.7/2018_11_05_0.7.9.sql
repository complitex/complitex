...
ALTER TABLE ownership_correction CHANGE COLUMN `end_date` `end_date` DATE DEFAULT '2054-12-31' COMMENT 'Дата окончания актуальности соответствия';
...
ALTER TABLE privilege_correction CHANGE COLUMN `end_date` `end_date` DATE DEFAULT '2054-12-31' COMMENT 'Дата окончания актуальности соответствия';
