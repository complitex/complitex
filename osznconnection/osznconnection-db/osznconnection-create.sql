...
CREATE TABLE `subsidy_tarif` (
    ...
    `T11_NORM_U` DECIMAL(10, 4) COMMENT '',
    `T11_NOR_US` DECIMAL(10, 4) COMMENT '',
    `T11_CODE_N` INTEGER(3) COMMENT '',
    `T11_COD_ND` INTEGER(3) COMMENT '',
    `T11_CD_UNI` INTEGER(3) COMMENT '',
    `T11_CS_UNI` DECIMAL (10, 4) COMMENT '',
    `T11_NORM` DECIMAL (10, 4) COMMENT '',
    `T11_NRM_DO` DECIMAL (10, 4) COMMENT '',
    `T11_NRM_MA` DECIMAL (10, 4) COMMENT '',
    `T11_K_NADL` DECIMAL (10, 4) COMMENT '',
     PRIMARY KEY (`id`)
