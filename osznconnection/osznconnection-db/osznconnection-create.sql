...
CREATE TABLE `payment` (
  ...
  `OWN_NUM_SR` VARCHAR(30) COMMENT 'Лицевой счет в обслуж. организации',
  ...
  `CODE3_1` INTEGER(10) COMMENT 'Код тарифа оплаты жилья',
  `CODE3_2` INTEGER(10) COMMENT 'Код тарифа отопления',
  `CODE3_3` INTEGER(10) COMMENT 'Код тарифа горячего водоснабжения',
  `CODE3_4` INTEGER(10) COMMENT 'Код тарифа холодного водоснабжения',
  `CODE3_5` INTEGER(10) COMMENT 'Код тарифа - газоснабжение',
  `CODE3_6` INTEGER(10) COMMENT 'Код тарифа-электроэнергии',
  `CODE3_7` INTEGER(10) COMMENT 'Код тарифа - вывоз мусора',
  `CODE3_8` INTEGER(10) COMMENT 'Код тарифа - водоотведение',
  `CODE3_17` INTEGER(10),
  `CODE3_18` INTEGER(10),
  `CODE3_19` INTEGER(10),
  `CODE3_20` INTEGER(10),
...
CREATE TABLE `privilege_prolongation` (
  ...
  `LGCODE` INTEGER(6) COMMENT 'Код услуги',
...
CREATE TABLE `oschadbank_response_file` (
  ...
  PRIMARY KEY (`id`),
  KEY `key_request_file_id` (`request_file_id`),
  CONSTRAINT `fk_oschadbank_response_file__request_file` FOREIGN KEY (`request_file_id`)  REFERENCES `request_file` (`id`) ON DELETE CASCADE
...
CREATE TABLE `oschadbank_response` (
  ...
  PRIMARY KEY (`id`),
  KEY `key_request_file_id` (`request_file_id`),
  CONSTRAINT `fk_oschadbank_response__request_file` FOREIGN KEY (`request_file_id`)  REFERENCES `request_file` (`id`) ON DELETE CASCADE
