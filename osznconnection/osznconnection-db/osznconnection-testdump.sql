...
insert into organization_string_culture(id, locale_id, value) values
  ...
  (23,@system_locale_id, UPPER('123456')),
...
INSERT INTO `request_file_field_description` VALUES (280,7,'T11_NORM_U','java.math.BigDecimal',10,4);
INSERT INTO `request_file_field_description` VALUES (281,7,'T11_NOR_US','java.math.BigDecimal',10,4);
...
INSERT INTO `request_file_field_description` VALUES (285,7,'T11_CS_UNI','java.math.BigDecimal',10,4);
INSERT INTO `request_file_field_description` VALUES (286,7,'T11_NORM','java.math.BigDecimal',10,4);
INSERT INTO `request_file_field_description` VALUES (287,7,'T11_NRM_DO','java.math.BigDecimal',10,4);
INSERT INTO `request_file_field_description` VALUES (288,7,'T11_NRM_MA','java.math.BigDecimal',10,4);
INSERT INTO `request_file_field_description` VALUES (289,7,'T11_K_NADL','java.math.BigDecimal',10,4);
...
insert into street_correction(id, city_id, street_type_id, organization_id, correction, object_id, module_id)
  values (1,1, 10012, 2,UPPER('Терешковой Соответствие'),1,0);
insert into building_correction(street_id, organization_id, correction, correction_corp, object_id, module_id)
...
insert into district_correction(city_id, organization_id, correction, object_id, module_id) values (2, 2,UPPER('Центральный'),3,0);
