...
update sequence set sequence_value = 100 where sequence_name = 'organization_type_string_value';
update sequence set sequence_value = 100 where sequence_name = 'organization_type';
update sequence set sequence_value = 100 where sequence_name = 'tarif_group_string_value';
update sequence set sequence_value = 100 where sequence_name = 'tarif_group';
update sequence set sequence_value = (select IFNULL(max(`id`), 0) from `tarif_string_value`)+1 where sequence_name = 'tarif_string_value';
update sequence set sequence_value = (select IFNULL(max(`object_id`), 0) from `tarif`)+1 where sequence_name = 'tarif';
update sequence set sequence_value = 100 where sequence_name = 'heatmeter_type_string_value';
update sequence set sequence_value = 100 where sequence_name = 'heatmeter_type';
update sequence set sequence_value = 100 where sequence_name = 'heatmeter_period_type_string_value';
update sequence set sequence_value = 100 where sequence_name = 'heatmeter_period_type';
update sequence set sequence_value = 100 where sequence_name = 'service' or sequence_name = 'service_string_value';