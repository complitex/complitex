...
import static ru.complitex.eirc.registry.entity.RegistryRecordStatus.*;
...
public class RegistryRecordWorkflowManager {
     ...
     * @throws ru.complitex.eirc.registry.service.TransitionNotAllowed if record processing is not possible
     */
