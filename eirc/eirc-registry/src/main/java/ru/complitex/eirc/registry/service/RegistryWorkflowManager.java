...
import static ru.complitex.eirc.registry.entity.RegistryStatus.*;
...
public class RegistryWorkflowManager {
     ...
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKED},
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#ROLLBACKED},
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSING_CANCELED} or
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSED_WITH_ERROR}
     *
     * @param registry Registry to check
     ...
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#LOADED},
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKING_CANCELED} or
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKED_WITH_ERROR}
     *
     * @param registry Registry to check
    ...
    /**
     * Set registry linking status to {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKING_WITH_ERROR}
     *
     * @param registry Registry to update
     * @throws TransitionNotAllowed if registry status is not {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKING}
     *                              or {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKING_WITH_ERROR}
     */
    ...
    /* Set registry loading status to {@load ru.complitex.eirc.registry.entity.RegistryStatus#LOADING_WITH_ERROR}
     *
     * @param registry Registry to update
     * @throws TransitionNotAllowed if registry status is not {@load ru.complitex.eirc.registry.entity.RegistryStatus#LOADING}
     *                              or {@load ru.complitex.eirc.registry.entity.RegistryStatus#LOADING_WITH_ERROR}
     */
    ...
    /**
     * Set registry processing status to {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSING_WITH_ERROR}
     *
     * @param registry Registry to update
     * @throws TransitionNotAllowed if registry status is not {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSING}
     *                              or {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSING_WITH_ERROR}
     */
    ...
    /**
     * Set registry canceled status to {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKING_CANCELED}
     *
     * @param registry Registry to update
     * @throws TransitionNotAllowed if registry status is not {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKING}
     *                              or {@link ru.complitex.eirc.registry.entity.RegistryStatus#LINKING_WITH_ERROR}
    ...
    /**
     * Set registry canceled status to {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSING_CANCELED}
     *
     * @param registry Registry to update
     * @throws TransitionNotAllowed if registry status is not {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSING}
     *                              or {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSING_WITH_ERROR}
    ...
    /**
     * Set registry canceled status to {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSED_PARTLY} or
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSED_WITH_ERROR}
     *
     * @param registry Registry to update
     * @throws TransitionNotAllowed if registry status is not {@link ru.complitex.eirc.registry.entity.RegistryStatus#ROLLBACKING}
     */
     ...
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSED},
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSED_PARTLY} or
     * {@link ru.complitex.eirc.registry.entity.RegistryStatus#PROCESSED_WITH_ERROR}
     *
     * @param registry Registry to check
