...
import ru.complitex.eirc.mb_transformer.util.MbParsingConstants;
...
import ru.complitex.eirc.registry.service.handle.MbConverterQueueProcessor;
import ru.complitex.eirc.registry.service.parse.FileReader;
import ru.complitex.eirc.registry.service.parse.ParseRegistryConstants;
import ru.complitex.eirc.registry.service.parse.RegistryFormatException;
import ru.complitex.eirc.registry.util.FileUtil;
import ru.complitex.eirc.registry.util.ParseUtil;
...
import static ru.complitex.eirc.registry.service.parse.ParseRegistryConstants.*;
...
public class EircPaymentRegistryConverter {

    private static final Logger log = LoggerFactory.getLogger(EircPaymentRegistryConverter.class.getClass());
