...
import ru.complitex.common.util.*;
    ...
    public void importCountry(IImportListener listener, Locale locale, Date beginDate)
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                Long objectId = null;//countryStrategy.getObjectId(externalId);
                if (objectId != null) {
    ...
    public void importRegion(IImportListener listener, Locale locale, Date beginDate)
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                // Ищем по externalId в базе.
                Long objectId = null;//regionStrategy.getObjectId(externalId);
                if (objectId != null) {
                ...
                //COUNTRY_ID
                Long countryId = null;//countryStrategy.getObjectId(line[1].trim());
                if (countryId == null) {
    ...
    public void importCityType(IImportListener listener, Locale locale, Date beginDate)
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                // Ищем по externalId в базе.
                Long objectId = null;//cityTypeStrategy.getObjectId(externalId);
                if (objectId != null) {
    ...
    public void importCity(IImportListener listener, Locale locale, Date beginDate)
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                //REGION_ID
                Long regionId = null;//regionStrategy.getObjectId(line[1].trim());
                if (regionId == null) {
                ...
                //CITY_TYPE_ID
                Long cityTypeId = null;//cityTypeStrategy.getObjectId(line[2].trim());
                if (cityTypeId == null) {
    ...
    public void importDistrict(IImportListener listener, Locale locale, Date beginDate)
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                // Ищем по externalId в базе.
                Long objectId = null;//districtStrategy.getObjectId(externalId);
                if (objectId != null) {
                ...
                //CITY_ID
                Long cityId = null;//cityStrategy.getObjectId(line[1].trim());
                if (cityId == null) {
    ...
    public void importStreetType(IImportListener listener, Locale locale, Date beginDate)
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                // Ищем по externalId в базе.
                Long objectId = null;//streetTypeStrategy.getObjectId(externalId);
                if (objectId != null) {
    ...
    public void importStreet(IImportListener listener, Locale locale, Date beginDate)
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                // Ищем по externalId в базе.
                Long objectId = null;//streetStrategy.getObjectId(externalId);
                if (objectId != null) {
                ...
                //STREET_TYPE_ID
                Long streetTypeId = null;//streetTypeStrategy.getObjectId(line[2].trim());
    ...
    private void importBuilding(IImportListener listener, Locale locale, Date beginDate) throws ImportFileNotFoundException,
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                Long streetObjectId = null;//streetStrategy.getObjectId(streetExternalId);
                ...
                Long districtObjectId = null;//districtStrategy.getObjectId(districtExternalId);
...
//                    }
                ...
                //organization
                Long organizationId = null;//organizationStrategy.getObjectId(organizationExternalId);
                ...
                if (organizationId != null) {
                    ...
                    Long buildingCodeInt = null;
                    try {
                        buildingCodeInt = Long.valueOf(buildingCode);
