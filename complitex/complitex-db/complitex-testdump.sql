...
INSERT INTO `city_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`, `value_type_id`) VALUES (1,10000,1300,10000,1300),
...
INSERT INTO `city_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`, `value_type_id`) VALUES
...
INSERT INTO `street_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`, `value_type_id`) VALUES (1,10000,1400,10000,1400),
...
INSERT INTO `street_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`, `value_type_id`) VALUES
...
insert into room_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
...
insert into apartment_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
...
insert into building_address_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
(1,1,1500,1,1500),
(1,2,1500,6,1500),
(1,3,1500,2,1500),
(1,4,1500,3,1500),
...
(8,9,1500);
insert into building_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
...
(6,3,400);
insert into street_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
...
insert into district_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
...
insert into city_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
...
insert into region_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
(1,1,700,1,700),
(1,2,700,2,700),
(1,3,700,3,700);
...
insert into country_attribute(attribute_id, object_id, entity_attribute_id, value_id, value_type_id) values
(1,1,800,1,800),
(1,2,800,2,800);