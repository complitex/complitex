...
INSERT INTO `city_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES (1,10000,1300,10000),
(1,10001,1300,10001);
INSERT INTO `city_type_string_value`(`id`, `locale_id`, `value`) VALUES (10002,1,'ГОРОД'), (10002,2,'МIСТО'), (10003,1,'ДЕРЕВНЯ'), (10003,2,'СЕЛО');
INSERT INTO `city_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES
(1,10000,1301,10002),(1,10001,1301,10003);
...
INSERT INTO `street_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES (1,10000,1400,10000),
(1,10001,1400,10001), (1,10002,1400,10002), (1,10003,1400,10003), (1,10004,1400,10004), (1,10005,1400,10005),
(1,10006,1400,10006), (1,10007,1400,10007), (1,10008,1400,10008), (1,10009,1400,10009), (1,10010,1400,10010),
(1,10011,1400,10011), (1,10012,1400,10012), (1,10013,1400,10013), (1,10014,1400,10014), (1,10015,1400,10015),
(1,10016,1400,10016);
...
INSERT INTO `street_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES
(1,10000,1401,10017), (1,10001,1401,10018), (1,10002,1401,10019), (1,10003,1401,10020), (1,10004,1401,10021),
(1,10005,1401,10022), (1,10006,1401,10023), (1,10007,1401,10024), (1,10008,1401,10025), (1,10009,1401,10026),
(1,10010,1401,10027), (1,10011,1401,10028), (1,10012,1401,10029), (1,10013,1401,10030), (1,10014,1401,10031),
(1,10015,1401,10032), (1,10016,1401,10033);
...
insert into room_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,200,1), (1,2,200,2), (1,3,200,3), (1,4,200,4);
...
insert into apartment_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,100,1), (1,2,100,2), (1,3,100,3),(1,4,100,4);
...
insert into building_address_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,1500,1),
(1,2,1500,6),
(1,3,1500,2),
(1,4,1500,3),
...
(8,9,1500);
insert into building_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,500,2),(1,1,501,2),
(1,3,500,2),
(1,4,500,1),
(1,5,500,1),
...
(6,3,400);
insert into street_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,300,1),(1,1,301,10012),
(1,2,300,2),(1,2,301,10012),
(1,3,300,3),(1,3,301,10008),
(1,4,300,4),(1,4,301,10012),
(1,5,300,5),(1,5,301,10012),
(1,6,300,6),(1,6,301,10008);
...
insert into district_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,600,1),(1,1,601,4),
(1,2,600,2),(1,2,601,5),
(1,3,600,3),(1,3,601,6),
(1,4,600,7),(1,4,601,8);
...
insert into city_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,400,1),(1,1,401,10000),
(1,2,400,2),(1,2,401,10000),
(1,3,400,3),(1,3,401,10000);
...
insert into region_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,700,1),
(1,2,700,2),
(1,3,700,3);
...
insert into country_attribute(attribute_id, object_id, entity_attribute_id, value_id) values
(1,1,800,1),
(1,2,800,2);