...
import ru.complitex.pspoffice.frontend.web.address.building.BuildingListPage;
...
import ru.complitex.pspoffice.frontend.web.domain.DomainPage;
import ru.complitex.pspoffice.frontend.web.entity.EntityListPage;
import ru.complitex.pspoffice.frontend.web.entity.EntityPage;
...
public class PspOfficeFontendWebApplication extends WebApplication{
    ...
    private void configureMount(){
        ...
        mountPage("card", ApartmentCardListPage.class);
