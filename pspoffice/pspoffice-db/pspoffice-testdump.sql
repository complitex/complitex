...
INSERT INTO `owner_relationship_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES
(1,4,2200,4),(1,5,2200,5),(1,6,2200,6),(1,7,2200,7),(1,8,2200,8);
...
INSERT INTO `ownership_form_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES
(1,1,2500,1),(1,2,2500,2),(1,3,2500,3),(1,4,2500,4),(1,5,2500,5),(1,6,2500,6), (1,7,2500,7),
 (1,8,2500,8);
...
INSERT INTO `registration_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES
(1,2,2600,2);
...
INSERT INTO `document_type_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES
(1,3,2700,3);
...
INSERT INTO `military_service_relation_attribute`(`attribute_id`, `object_id`, `entity_attribute_id`, `value_id`) VALUES
(1,1,2900,1),(1,2,2900,2),(1,3,2900,3);
...
(1,1,900,1), (1,1,901,2), (1,1,904,1),
(1,2,900,3), (1,2,901,4), (1,2,904,1);
